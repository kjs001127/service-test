...
INSERT INTO command_toggle_hooks (app_id, toggle_function_name) SELECT app_id, toggle_function_name FROM command_activation_settings WHERE toggle_function_name IS NOT NULL;
