...
func (a *AppDisplayDAO) FindPublicDisplays(ctx context.Context, since string, limit int) ([]*display.AppDisplay, error) {
...
func (a *AppDisplayDAO) FindDisplay(ctx context.Context, appID string) (*display.AppDisplay, error) {
...
func (a *AppDisplayDAO) FindDisplays(ctx context.Context, appIDs []string) ([]*display.AppDisplay, error) {
...
func (a *AppDisplayDAO) Save(ctx context.Context, display *display.AppDisplay) (*display.AppDisplay, error) {
...
func (a *AppDisplayDAO) marshal(displayTarget *display.AppDisplay) (*models.AppDisplay, error) {
...
func (a *AppDisplayDAO) unmarshal(rawDisplay *models.AppDisplay) (*display.AppDisplay, error) {
	...
	return &display.AppDisplay{
		...
		IsPrivate:          rawDisplay.IsPrivate,
		I18nMap:            i18nMap,
	}, nil
}

func (a *AppDisplayDAO) unmarshalAll(rawDisplays []*models.AppDisplay) ([]*display.AppDisplay, error) {
	ret := make([]*display.AppDisplay, 0, len(rawDisplays))
