...
type AppInstallationRepository interface {
	...
	FetchAllByChannel(ctx context.Context, channelID string) ([]*model.AppInstallation, error)
	FetchAllByAppID(ctx context.Context, appID string) ([]*model.AppInstallation, error)
